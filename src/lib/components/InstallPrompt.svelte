	...
	<div class="fixed bottom-0 left-0 right-0 z-50 p-4 sm:p-6 pointer-events-none">
		...
		>
			<div class="flex items-start gap-4">
				<div
					class="shrink-0 w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center text-white text-2xl font-bold"
				>
					$
				</div>
	...
	>
		...
		>
			<div class="flex justify-between items-start mb-4">
				<h3 class="text-xl font-bold text-gray-900">Cómo Instalar en iOS</h3>
