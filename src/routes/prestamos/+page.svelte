								...
								<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
									...
									<div class="bg-gray-50 rounded-lg p-4">
										<div class="flex justify-between text-sm mb-2">
											<span class="text-gray-600">Progreso del pago:</span>
											<span class="font-semibold text-gray-900">
												{Math.min(prestamo.meses_transcurridos, prestamo.plazo_meses)} / {prestamo.plazo_meses} meses
											</span>
										</div>
										<div class="w-full bg-gray-200 rounded-full h-2">
											<div
												class="bg-gray-800 h-2 rounded-full transition-all"
												style="width: {Math.min((prestamo.meses_transcurridos / prestamo.plazo_meses) * 100, 100)}%"
											></div>
										</div>
									</div>
								</div>
